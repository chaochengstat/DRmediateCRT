...
This vignette demonstrates the use of the R package `DRmediateCRT` to assess mediation effects in cluster-randomized trials based on the semiparametric methods that developed in [Cheng and Li (2024)](https://arxiv.org/abs/2404.18256). The `DRmediateCRT` package is available at [https://github.com/chaochengstat/DRmediateCRT](https://github.com/chaochengstat/DRmediateCRT) and can be installed as follows
```{r, eval = FALSE}
devtools::install_github("chaochengstat/DRmediateCRT")
```
